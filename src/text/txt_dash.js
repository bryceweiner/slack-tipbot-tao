...
const tipbotTxt = {
  ...
  'helpText': [
    ...
    '\t\t_@TaoBot what is my balance_',

    //'help_send':
    '*send*\t\t\t\ttell the bot to send coins to someone; \n' +
    '\t\t_@TaoBot send 0.1 TAO to @someone_ \n' +
    '\t\t_aliases: give, tip_ \n' +
    '\t\t\t\tWorks also with major fiat currencies (use *currencies* command to see the list); \n' +
    '\t\t_@TaoBot give 4 USD to @someone_',

    // 'help_deposit':
    '*deposit*\t\task the bot for a deposit address; _@TaoBot let me deposit!_',
    ...
    '\t\t_@TaoBot withdraw 1 TAO to XqyTXt9LM3AHdrfG8ckdTatDiwk5514a11_',

    // 'help_currencies':
    '*currencies*\task the bot for a list of supported currencies.\n' +
    '\t\t_@TaoBot what currencies do you know?_ ',

    // 'help_price':
    '*price*\t\t\task the bot for the Tao price in a particular currency. Price info from coinmarketcap.\n ' +
    '\t\t_@TaoBot price in USD!_ ',
  ...
  '\t\t\tEach user that has tipped another user will receive a _raindrop_ (read: free Tao) from the rain fund when the donation threshold is reached.',
  ...
  '\t\t_@TaoBot autowithdraw 0.5 TAO XqyTXt9LM3AHdrfG8ckdTatDiwk5514a11',
  ...
  '\t\t\t\tbetween all the users that tipped. Defaults to 0.5 Tao.\n' +
  '\t\t_@taobot rain threshold 1 dash_\n' +
  '\n' +
  ...
  // NEW USER
  'WarningNewUser1': 'A new user joins Tao Nation! A warm welcome to our Slack, ',
  'WarningNewUser2': '.',
  ...
  'SupportedBase': 'And does it need saying: *TAO* is supported !',
  ...
  'RainThresholdNotSet': 'Dear Tao God, the Rain threshold isn\'t set yet. \n' +
  ' You can do that with the *rain threshold _amount_* command.',
  // 'RainTimer': 'Rainshine will be checked every *',
  // 'RainTimerUnit': ' minute(s)*',
  // 'RainTimerNotSet': 'Dear Tao God, the rain timer is not set yet.\n' +
  ...
  'RainRecieved': 'As reward of tipping your fellow Tao user(s) you received a raindrop of ',
...
const userTxt = {
  ...
  'BalanceWarningHigh': 'This tip jar is filling up. Please consider withdrawing some Tao.',
  ...
  'SendPrivateMssSendingUser': ' you\'re a great Tao Chat user :thumbsup: \nLets see how much there is left in your tip jar now: \n',
